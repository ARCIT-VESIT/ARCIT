...
def handle_otp_post(request):
    ...
    if 'Otp' not in request.POST:
        ...
        try:
            ...
            return render(request, "Authentication/otp.html", { "phone_number": request.POST['Phone_number'], })
            ...
            if request.session.has_key('generated_otp'):
                clear_session_otp(request)

            return render(request, "Authentication/otp.html", {"error": error})
    ...
    return render(request, "Authentication/otp.html", args)
